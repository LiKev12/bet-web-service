package com.bet.betwebservice.v2;
...
public class AppService {
    ...
    public PodPageModel getPodPage(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idPod = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public PodCardsPaginatedModel getPodCardsDiscover(JsonNode rb) throws Exception {
        ...
        String filterNameOrDescription = RequestBodyFormatterV2.fStringLowercase(rb.get("filterNameOrDescription"));
        boolean filterIsPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsPublic"));
        boolean filterIsNotPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotPublic"));
        boolean filterIsMember = RequestBodyFormatterV2.fBoolean(rb.get("filterIsMember"));
        boolean filterIsNotMember = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotMember"));
        boolean filterIsModerator = RequestBodyFormatterV2.fBoolean(rb.get("filterIsModerator"));
        boolean filterIsNotModerator = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotModerator"));
        int paginationIdxStart = RequestBodyFormatterV2.fInt(rb.get("paginationIdxStart"));
        int paginationN = RequestBodyFormatterV2.fInt(rb.get("paginationN"));

        List<PodCardSharedPropertiesDTO> podCardsDiscover_SharedProperties = this.podRepository
                .getPodCardsDiscover_SharedProperties(filterNameOrDescription, filterIsPublic, filterIsNotPublic);
        List<PodCardIndividualPropertiesDTO> podCardsDiscover_IndividualProperties = this.podRepository
                .getPodCardsDiscover_IndividualProperties(idUser, filterNameOrDescription, filterIsPublic,
                        filterIsNotPublic);
    ...
    public PodCardsPaginatedModel getPodCardsAssociatedWithStamp(JsonNode rb) throws Exception {
        ...
        String idStamp = RequestBodyFormatterV2.fString(rb.get("id"));
        String filterNameOrDescription = RequestBodyFormatterV2.fStringLowercase(rb.get("filterNameOrDescription"));
        boolean filterIsPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsPublic"));
        boolean filterIsNotPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotPublic"));
        boolean filterIsMember = RequestBodyFormatterV2.fBoolean(rb.get("filterIsMember"));
        ...
        List<PodCardSharedPropertiesDTO> podCardsAssociatedWithStamp_SharedProperties = this.podRepository
                .getPodCardsAssociatedWithStamp_SharedProperties(idStamp, filterNameOrDescription, filterIsPublic,
                        filterIsNotPublic);
        List<PodCardIndividualPropertiesDTO> podCardsAssociatedWithStamp_IndividualProperties = this.podRepository
                .getPodCardsAssociatedWithStamp_IndividualProperties(idStamp, idUser, filterNameOrDescription,
    ...
    public PodCardsPaginatedModel getPodCardsAssociatedWithUser(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        ...
                        "paginationIdxStart",
                        "paginationN"));
        String idUserProfile = RequestBodyFormatterV2.fString(rb.get("id"));
        String filterNameOrDescription = RequestBodyFormatterV2.fStringLowercase(rb.get("filterNameOrDescription"));
        boolean filterIsPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsPublic"));
        boolean filterIsNotPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotPublic"));
        boolean filterIsMember = RequestBodyFormatterV2.fBoolean(rb.get("filterIsMember"));
        ...
        List<PodCardSharedPropertiesDTO> podCardsAssociatedWithUser_SharedProperties = this.podRepository
                .getPodCardsAssociatedWithUser_SharedProperties(filterNameOrDescription, filterIsPublic,
                        filterIsNotPublic);
        List<PodCardIndividualPropertiesDTO> podCardsAssociatedWithUser_IndividualProperties = this.podRepository
                .getPodCardsAssociatedWithUser_IndividualProperties(idUser, filterNameOrDescription, filterIsPublic,
                        filterIsNotPublic);
    ...
    public PodPageModel createPod(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "name",
                        "isPublic"));
        String name = RequestBodyValidatorV2.stringRequired(RequestBodyFormatterV2.fString(rb.get("name")),
                Limits.POD_NAME_MIN_LENGTH_CHARACTERS, Limits.POD_NAME_MAX_LENGTH_CHARACTERS);
        boolean isPublic = RequestBodyFormatterV2.fBoolean(rb.get("isPublic"));
        ...
        if (rb.has("description")) {
            String description = RequestBodyValidatorV2.stringOptional(
                    RequestBodyFormatterV2.fString(rb.get("description")), Limits.POD_DESCRIPTION_MIN_LENGTH_CHARACTERS,
    ...
    public PodPageModel updatePod(JsonNode rb) throws Exception {
        ...
        PodEntity podEntity = this.podRepository.findById(UUID.fromString(idPod)).get();
        if (rb.has("name")) {
            String podName = RequestBodyValidatorV2.stringRequired(RequestBodyFormatterV2.fString(rb.get("name")),
                    Limits.POD_NAME_MIN_LENGTH_CHARACTERS, Limits.POD_NAME_MAX_LENGTH_CHARACTERS);
        ...
        if (rb.has("description")) {
            String podDescription = RequestBodyValidatorV2.stringOptional(
                    RequestBodyFormatterV2.fString(rb.get("description")), Limits.POD_DESCRIPTION_MIN_LENGTH_CHARACTERS,
                    Limits.POD_DESCRIPTION_MAX_LENGTH_CHARACTERS);
        ...
        if (rb.has("imageAsBase64String")) {
            String podImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("imageAsBase64String")));
    ...
    public List<UserBubbleModel> sendJoinPodInvite(JsonNode rb) throws Exception {
        ...
        for (int i = 0; i < rb.get("idUsers").size(); i++) {
            String idUserBecomeModerator = RequestBodyFormatterV2.fString(rb.get("idUsers").get(i));
        ...
        for (int i = 0; i < idUsersReceiveJoinPodInvite.size(); i++) {
            ...
            // (who haven't yet received an invite yet), and non-members don't have an entry
            // yet
            PodUserPodHasUserEntity podUserPodHasUserEntity = new PodUserPodHasUserEntity();
            podUserPodHasUserEntity.setTimestampUnix((int) Instant.now().getEpochSecond());
            podUserPodHasUserEntity.setIdPod(UUID.fromString(idPod));
    ...
    public List<UserBubbleModel> approveBecomePodModeratorRequests(JsonNode rb) throws Exception {
        ...
        for (int i = 0; i < rb.get("idUsers").size(); i++) {
            String idUserSentBecomePodModeratorRequest = RequestBodyFormatterV2.fString(rb.get("idUsers").get(i));
    ...
    public List<UserBubbleModel> addPodModerators(JsonNode rb) throws Exception {
        ...
        for (int i = 0; i < rb.get("idUsers").size(); i++) {
            String idUserToBecomeModerator = RequestBodyFormatterV2.fString(rb.get("idUsers").get(i));
    ...
    public List<UserBubbleModel> getUserBubblesTaskComplete(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idTask = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public List<TaskModel> getTasksPersonal(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        ...
                        "filterIsNotPin"));
        String filterNameOrDescription = RequestBodyFormatterV2.fStringLowercase(rb.get("filterNameOrDescription"));
        boolean filterIsComplete = RequestBodyFormatterV2.fBoolean(rb.get("filterIsComplete"));
        boolean filterIsNotComplete = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotComplete"));
        boolean filterIsStar = RequestBodyFormatterV2.fBoolean(rb.get("filterIsStar"));
        boolean filterIsNotStar = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotStar"));
        boolean filterIsPin = RequestBodyFormatterV2.fBoolean(rb.get("filterIsPin"));
        boolean filterIsNotPin = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotPin"));

        List<TaskSharedPropertiesDTO> tasksPersonal_SharedProperties = this.taskRepository
                .getTasksPersonal_SharedProperties(idUser, filterNameOrDescription);
        List<TaskIndividualPropertiesDTO> tasksPersonal_IndividualProperties = this.taskRepository
                .getTasksPersonal_IndividualProperties(idUser, filterNameOrDescription);
    ...
    public List<TaskModel> getTasksAssociatedWithPod(JsonNode rb) throws Exception {
        ...
        List<TaskSharedPropertiesDTO> tasksAssociatedWithPod_SharedProperties = this.taskRepository
                .getTasksAssociatedWithPod_SharedProperties(idPod, filterNameOrDescription);
        List<TaskIndividualPropertiesDTO> tasksAssociatedWithPod_IndividualProperties = this.taskRepository
                .getTasksAssociatedWithPod_IndividualProperties(idPod, idUser, filterNameOrDescription);
        List<TaskModel> tasksPage = this._getTaskModelFromSharedAndIndividualProperties(
                idUser,
    ...
    public List<TaskModel> getTasksAssociatedWithStamp(JsonNode rb) throws Exception {
        ...
        List<TaskSharedPropertiesDTO> tasksAssociatedWithStamp_SharedProperties = this.taskRepository
                .getTasksAssociatedWithStamp_SharedProperties(idStamp, filterNameOrDescription);
        List<TaskIndividualPropertiesDTO> tasksAssociatedWithStamp_IndividualProperties = this.taskRepository
                .getTasksAssociatedWithStamp_IndividualProperties(idStamp, idUser, filterNameOrDescription);
        List<TaskModel> tasksPage = this._getTaskModelFromSharedAndIndividualProperties(
                idUser,
    ...
    public List<TaskModel> getPinnedTasksAssociatedWithUser(JsonNode rb) throws Exception {
        ...
        List<TaskSharedPropertiesDTO> tasksAssociatedWithUser_SharedProperties = this.taskRepository
                .getPinnedTasksAssociatedWithUser_SharedProperties(idUserProfile, filterNameOrDescription);
        List<TaskIndividualPropertiesDTO> tasksAssociatedWithUser_IndividualProperties = this.taskRepository
                .getPinnedTasksAssociatedWithUser_IndividualProperties(idUserProfile, filterNameOrDescription);
        List<TaskModel> tasksPage = this._getTaskModelFromSharedAndIndividualProperties(
                idUser,
    ...
    public TaskModel updateTask(JsonNode rb) throws Exception {
        ...
        if (rb.has("name")) {
            String taskName = RequestBodyValidatorV2.stringRequired(RequestBodyFormatterV2.fString(rb.get("name")),
        ...
        if (rb.has("description")) {
            String taskDescription = RequestBodyValidatorV2.stringOptional(
                    RequestBodyFormatterV2.fString(rb.get("description")),
        ...
        if (rb.has("imageAsBase64String")) {
            String taskImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("imageAsBase64String")));
        ...
        if (rb.has("numberOfPoints")) {
            int taskNumberOfPoints = RequestBodyValidatorV2.intRequired(
                    RequestBodyFormatterV2.fInt(rb.get("numberOfPoints")), Limits.TASK_NUMBER_OF_POINTS_MIN,
        ...
        if (rb.has("datetimeTarget")) {
            String taskDatetimeTarget = RequestBodyValidatorV2
                    .datetimeOptional(RequestBodyFormatterV2.fString(rb.get("datetimeTarget")));
        ...
        if (rb.has("isComplete")) {
            boolean taskIsComplete = RequestBodyFormatterV2.fBoolean(rb.get("isComplete"));
        ...
        if (rb.has("isStar")) {
            boolean taskIsStar = RequestBodyFormatterV2.fBoolean(rb.get("isStar"));
        ...
        if (rb.has("isPin")) {
            boolean taskIsPin = RequestBodyFormatterV2.fBoolean(rb.get("isPin"));
        ...
        if (rb.has("noteText")) {
            String taskNoteText = RequestBodyValidatorV2.stringOptional(
                    RequestBodyFormatterV2.fString(rb.get("noteText")), Limits.TASK_NOTE_TEXT_MIN_LENGTH_CHARACTERS,
        ...
        if (rb.has("noteImageAsBase64String")) {
            String taskNoteImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("noteImageAsBase64String")));
            TaskUserTaskNoteEntity taskUserTaskNoteEntity = this.taskUserTaskNoteRepository
                    .findByIdTaskIdUser(idTask, idUser).size() > 0
                            ? this.taskUserTaskNoteRepository.findByIdTaskIdUser(idTask, idUser).get(0)
                            : new TaskUserTaskNoteEntity();
    ...
    public void createTask(JsonNode rb) throws Exception {
        ...
        taskEntity.setNumberOfPoints(taskNumberOfPoints);
        if (rb.has("idPod")) {
            String taskIdPod = RequestBodyFormatterV2.fString(rb.get("idPod"));
    ...
    public void updateTaskReaction(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        ...
                        "reactionType"));
        String idTask = RequestBodyFormatterV2.fString(rb.get("id"));
        String reactionType = RequestBodyValidatorV2.stringChoice(
                RequestBodyFormatterV2.fString(rb.get("reactionType")), Constants.REACTION_TYPE_CHOICES);
    ...
    public void updateTaskCommentReaction(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id",
                        "reactionType"));
        String idTaskComment = RequestBodyFormatterV2.fString(rb.get("id"));
        String reactionType = RequestBodyValidatorV2.stringChoice(
                RequestBodyFormatterV2.fString(rb.get("reactionType")), Constants.REACTION_TYPE_CHOICES);
    ...
    public void updateTaskCommentReplyReaction(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id",
                        "reactionType"));
        String idTaskCommentReply = RequestBodyFormatterV2.fString(rb.get("id"));
        String reactionType = RequestBodyValidatorV2.stringChoice(
                RequestBodyFormatterV2.fString(rb.get("reactionType")), Constants.REACTION_TYPE_CHOICES);
    ...
    public void createTaskComment(JsonNode rb) throws Exception {
        ...
        String idTask = RequestBodyFormatterV2.fString(rb.get("id"));
        if (rb.has("text")) {
            String commentText = RequestBodyValidatorV2.stringOptional(RequestBodyFormatterV2.fString(rb.get("text")),
        ...
        if (rb.has("imageAsBase64String")) {
            String commentImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("imageAsBase64String")));
            TaskUserTaskCommentEntity taskUserTaskCommentEntity = new TaskUserTaskCommentEntity();
            taskUserTaskCommentEntity.setTimestampUnix((int) Instant.now().getEpochSecond());
            taskUserTaskCommentEntity.setIdTask(UUID.fromString(idTask));
    ...
    public void createTaskCommentReply(JsonNode rb) throws Exception {
        ...
        String idTaskComment = RequestBodyFormatterV2.fString(rb.get("id"));
        if (rb.has("text")) {
            String commentReplyText = RequestBodyValidatorV2.stringOptional(
                    RequestBodyFormatterV2.fString(rb.get("text")), Limits.TASK_COMMENT_TEXT_MIN_LENGTH_CHARACTERS,
        ...
        if (rb.has("imageAsBase64String")) {
            String commentReplyImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("imageAsBase64String")));
            TaskUserTaskCommentReplyEntity taskUserTaskCommentReplyEntity = new TaskUserTaskCommentReplyEntity();
            taskUserTaskCommentReplyEntity.setTimestampUnix((int) Instant.now().getEpochSecond());
            taskUserTaskCommentReplyEntity.setIdTaskComment(UUID.fromString(idTaskComment));
    ...
    public StampCardsPaginatedModel getStampCardsDiscover(JsonNode rb) throws Exception {
        ...
        boolean filterIsPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsPublic"));
        boolean filterIsNotPublic = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotPublic"));
        boolean filterIsCollect = RequestBodyFormatterV2.fBoolean(rb.get("filterIsCollect"));
        boolean filterIsNotCollect = RequestBodyFormatterV2.fBoolean(rb.get("filterIsNotCollect"));
        int paginationIdxStart = RequestBodyFormatterV2.fInt(rb.get("paginationIdxStart"));
        int paginationN = RequestBodyFormatterV2.fInt(rb.get("paginationN"));

        List<StampCardSharedPropertiesDTO> stampCardsDiscover_SharedProperties = this.stampRepository
                .getStampCardsDiscover_SharedProperties(filterNameOrDescription);
        List<StampCardIndividualPropertiesDTO> stampCardsDiscover_IndividualProperties = this.stampRepository
                .getStampCardsDiscover_IndividualProperties(idUser, filterNameOrDescription);
    ...
    public StampCardsPaginatedModel getStampCardsAssociatedWithPod(JsonNode rb) throws Exception {
        ...
        List<StampCardSharedPropertiesDTO> stampCardsAssociatedWithPod_SharedProperties = this.stampRepository
                .getStampCardsAssociatedWithPod_SharedProperties(idPod, filterNameOrDescription);
        List<StampCardIndividualPropertiesDTO> stampCardsAssociatedWithPod_IndividualProperties = this.stampRepository
                .getStampCardsAssociatedWithPod_IndividualProperties(idPod, idUser, filterNameOrDescription);
        StampCardsPaginatedModel stampCardsPaginatedModel = this._getStampCardModelFromSharedAndIndividualProperties(
                idUser,
    ...
    public StampCardsPaginatedModel getStampCardsAssociatedWithUser(JsonNode rb) throws Exception {
        ...
        List<StampCardSharedPropertiesDTO> stampCardsAssociatedWithPod_SharedProperties = this.stampRepository
                .getStampCardsAssociatedWithUser_SharedProperties(filterNameOrDescription);
        List<StampCardIndividualPropertiesDTO> stampCardsAssociatedWithPod_IndividualProperties = this.stampRepository
                .getStampCardsAssociatedWithUser_IndividualProperties(idUser, filterNameOrDescription);
    ...
    public StampPageModel createStamp(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "name",
                        "idTasks"));
        String stampName = RequestBodyValidatorV2.stringRequired(RequestBodyFormatterV2.fString(rb.get("name")),
                Limits.POD_NAME_MIN_LENGTH_CHARACTERS, Limits.POD_NAME_MAX_LENGTH_CHARACTERS);
        List<String> stampIdTasks = new ArrayList<>();
        for (int i = 0; i < rb.get("idTasks").size(); i++) {
            String stampIdTask = RequestBodyFormatterV2.fString(rb.get("idTasks").get(i));
    ...
    public StampPageModel updateStamp(JsonNode rb) throws Exception {
        ...
        if (rb.has("description")) {
            String stampDescription = RequestBodyValidatorV2.stringOptional(
                    RequestBodyFormatterV2.fString(rb.get("description")),
                    Limits.STAMP_DESCRIPTION_MIN_LENGTH_CHARACTERS, Limits.STAMP_DESCRIPTION_MAX_LENGTH_CHARACTERS);
        ...
        if (rb.has("imageAsBase64String")) {
            String stampImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("imageAsBase64String")));
        ...
        if (rb.has("idTasks")) {
            ...
            for (int i = 0; i < rb.get("idTasks").size(); i++) {
                String idTask = RequestBodyFormatterV2.fString(rb.get("idTasks").get(i));
                idTasks.add(idTask);
            }
    ...
    private StampCardsPaginatedModel _getStampCardModelFromSharedAndIndividualProperties(
        ...
        stampCardList = stampCardList.stream().filter(stampCard -> {
            ...
            if (!stampCard.isPublic()) {
                int numberOfPodsAssociatedWithStampUserIsMemberOf = this.stampRepository
                        .getNumberOfPodsAssociatedWithStampUserIsMemberOf(stampCard.getId().toString(), idViewingUser);
                int numberOfPodsAssociatedWithStampTotal = this.stampRepository
                        .getNumberOfPodsAssociatedWithStampTotal(stampCard.getId().toString());
    ...
    public UserPageModel getUserPage(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idUserOfUserPage = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public UserPageModel updateUserPage(JsonNode rb) throws Exception {
        ...
        if (rb.has("username")) {
            String userUsername = RequestBodyValidatorV2.stringRegex(
                RequestBodyValidatorV2.stringRequired(RequestBodyFormatterV2.fString(rb.get("username")),
            ...
            if (userEntitiesWithSameUsername.size() > 0
                    && !userEntitiesWithSameUsername.get(0).getId().toString().equals(idUserOfUserPage)) {
        ...
        if (rb.has("name")) {
            String userName = RequestBodyValidatorV2.stringRequired(RequestBodyFormatterV2.fString(rb.get("name")),
        ...
        if (rb.has("bio")) {
            String userBio = RequestBodyValidatorV2.stringOptional(RequestBodyFormatterV2.fString(rb.get("bio")),
        ...
        if (rb.has("imageAsBase64String")) {
            String userImageAsBase64String = RequestBodyValidatorV2
                    .imageOptional(RequestBodyFormatterV2.fString(rb.get("imageAsBase64String")));
    ...
    public List<UserBubbleModel> getUserBubblesFollowing(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idUserBeingViewed = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public void sendFollowUserRequest(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idUserReceiveFollowRequest = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public void unfollowUser(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idUserToBeUnfollowed = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public List<UserBubbleModel> acceptFollowUserRequests(JsonNode rb) throws Exception {
        ...
        for (int i = 0; i < rb.get("idUsers").size(); i++) {
            String idUserWithFollowRequestAccepted = RequestBodyFormatterV2.fString(rb.get("idUsers").get(i));
    ...
    public List<UserBubbleModel> declineFollowUserRequests(JsonNode rb) throws Exception {
        ...
        for (int i = 0; i < rb.get("idUsers").size(); i++) {
            String idUserWithFollowRequestDeclined = RequestBodyFormatterV2.fString(rb.get("idUsers").get(i));
    ...
    public void dismissNotification(JsonNode rb) throws Exception {
        ...
        RequestBodyValidatorV2.verifyRequiredFieldNamesExist(
                ...
                Arrays.asList(
                        "id"));
        String idNotification = RequestBodyFormatterV2.fString(rb.get("id"));
    ...
    public AccountSettingsPageModel updateAccountSettingsPage(JsonNode rb) throws Exception {
        ...
        UserEntity userEntity = this.userRepository.findById(UUID.fromString(idUser)).get();
        if (rb.has("timeZone")) {
            String userTimeZone = RequestBodyValidatorV2.stringChoice(
    ...
    public void changePassword(JsonNode rb) throws Exception {
        String idUser = jwtTokenWrapper.getJwtTokenSubject();
        String currentPassword = RequestBodyValidatorV2.stringRequired(
            RequestBodyFormatterV2.fString(rb.get("currentPassword")), 
        ...
        String newPasswordConfirmed = RequestBodyValidatorV2.stringRequired(
            RequestBodyFormatterV2.fString(rb.get("newPasswordConfirmed")), 
            Limits.USER_PASSWORD_MIN_LENGTH_CHARACTERS, 
            Limits.USER_PASSWORD_MAX_LENGTH_CHARACTERS
        );
