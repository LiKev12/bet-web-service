...
public interface StampRepository extends JpaRepository<StampEntity, UUID> {
    ...
    @Query("SELECT \n" +
            ...
            "LOWER(stamp.name) LIKE CONCAT('%',:filterNameOrDescription,'%') OR LOWER(stamp.description) LIKE CONCAT('%',:filterNameOrDescription,'%')\n" +
            "GROUP BY stamp.id")
    ...
    @Query("SELECT \n" +
            ...
            "FROM StampEntity stamp\n" +
            "LEFT JOIN StampUserUserCollectStampEntity stamp_user_user_collect_stamp on stamp_user_user_collect_stamp.idStamp = stamp.id\n" +
            "WHERE LOWER(stamp.name) LIKE CONCAT('%',:filterNameOrDescription,'%') OR LOWER(stamp.description) LIKE CONCAT('%',:filterNameOrDescription,'%')\n" +
            "GROUP BY stamp.id")
